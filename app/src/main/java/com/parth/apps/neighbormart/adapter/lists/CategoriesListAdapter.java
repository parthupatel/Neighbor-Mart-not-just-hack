package com.apps.neighbormart.adapter.lists;
...
public class CategoriesListAdapter extends RecyclerView.Adapter<CategoriesListAdapter.mViewHolder> {
    ...
    public void onBindViewHolder(final mViewHolder holder, final int position) {
        ...
        if (selectedPos == position){
            ...
            holder.image.setImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.white)));
        }else {
            ...
            holder.image.setImageTintList(ColorStateList.valueOf(context.getResources().getColor(R.color.defaultColorText)));
        }
